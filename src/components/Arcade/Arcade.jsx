...
class Arcade extends Component {
  ...
  setCSS = () => this.setState({ opponentImage: flask, opponentName: 'CSS3', opponentDescription: 'Cascading Style Sheet', onSound: false, onSound2: true  })
  ...
  setReact = () => this.setState({ opponentImage: flask, opponentName: 'React.js', opponentDescription: 'JavaScript Library', onSound: false, onSound2: true  })
  
  setPython = () => this.setState({ opponentImage: flask, opponentName: 'Python 3', opponentDescription: 'Scripting Language', onSound: false, onSound2: true  })
  
  setDjango = () => this.setState({ opponentImage: flask, opponentName: 'Django', opponentDescription: 'Python Framework', onSound: false, onSound2: true  })
